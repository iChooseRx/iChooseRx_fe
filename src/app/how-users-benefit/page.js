    ...
    <>
      ...
      <main className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground p-6 text-center">
        ...
        <p className="text-lg text-gray-500 dark:text-gray-400 max-w-xl mb-8">
          We're making it easier than ever to find the right medications for your needs, values, lifestyle, and health goals. Full content coming soon!
        </p>
        ...
        <section className="text-left max-w-2xl">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Whether you're avoiding certain additives, managing allergies, or living according to specific lifestyle choices, iChooseRx helps you quickly search FDA-approved drugs that match your criteria — without endless guesswork.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              iChooseRx was built because this tool didn’t exist — until now. We're dedicated to giving you transparent, conscious options when it comes to your health decisions.
            </p>
          </div>
