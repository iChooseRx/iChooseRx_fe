      ...
      <main className="min-h-screen bg-background text-foreground p-6">
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            Apply filters to exclude inactive ingredients (excipients) you don't want in your medication.
            Click Search.
        ...
        <section className="mb-8">
          ...
          <p>
            Click the "Save" button on any search result to add it to your saved list. Navigate to the saved drugs section (using the menu button at the top right of the page),
        ...
        <section className="mb-8">
          ...
          <p>
            When you view a drug's details (click + details), scroll down to the <strong>Description</strong> field, you'll see a section like "Inactive Ingredients" make sure to confirm the inactive ingredients match your filters. There will also be a decsciption of each strength of the result. Once you confirm the strength you want matches your wants or needs, scroll down to the <strong>How Supplied</strong> field.
            This is where you can find the exact NDC that matches the dosage or strength you’re looking for. You'll see something like this in the <strong>How Supplied</strong> field with all of the strengths "5 mg: White to off white round tablets with ‘T370’ debossed on one side and four partial bisects on other side. <strong>NDC 43602-982-15</strong>". You'll want to add that NDC to the notes of your saved drug for reference. Now you can easily add that NDC to the availability report once you find it in the next step. If there is no NDC in the <strong>How Supplied</strong> field, then it may mean there is only one strength and you may be able to use the <strong>Package NDC</strong> number to find the drug at a pharmacy.
            Crowdsourcing: Call your local pharmacies (shop local) and ask for a pharmacist, tell them the NDCs you are looking for, and they'll search and tell you if they have it available. Please report if you found a drug to help us spread awareness and empowerment to our users.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            Fill out the form with the <strong>Pharmacy Name, Street Address, City, State, Zip, Phone, and the NDC(s)</strong> you found. You can also add additional helpful notes. Then this report will go to the Administrator (Me), i'll call to confirm, and them BOOM! we now have either a new pharmacy in our database with this new inventory, or we add this found drug to a pharmacy that we already have in the database. THANK YOU!
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Navigate to the pharmacy search page by clicking "Saved Drugs & Pharmacies" in the menu button (same page as saved drugs) and enter the NDC you’re looking for.
            You’ll see which pharmacies (if any) have that NDC reported in our system.
        ...
        <section className="mb-8">
          ...
          <p>
            If a pharmacy no longer has an NDC after you called to check, click <strong>“Report Unavailable”</strong> in the pharmacy view. An Administrator will get the report (Me), and then will confirm or deny to remove the NDC from that pharmacy's inventory.
