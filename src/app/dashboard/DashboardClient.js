...
//  * - Renders the "Saved Drugs" & "Search" UI
//  * - Uses useState, useEffect (hooks)
//  * - Receives `initialDrugs` from the Server Component (page.js)
//  * - Performs client-side updates/requests without full page reloads
//  */
// export default function DashboardClient({ initialDrugs }) {
//   // Store the SSR data in state
//   const [drugs, setdrugs] = useState(initialDrugs || []);
//   const [drugName, setDrugName] = useState('');
//   const [searchResults, setSearchResults] = useState([]);
//   const [expandedSearchId, setExpandedSearchId] = useState(null);
//   const [selectedDrug, setSelectedDrug] = useState(null); // Default null
...
//   /**
//    * Helper: Re-fetch saved drugs from the backend after creating/deleting
//    */
//   async function fetchdrugs() {
//     try {
//       // We can use a direct fetch or your axios-based `getSaveddrugs()` from services/api
//       // Example with fetch:
//       const res = await fetch(`${process.env.NEXT_PUBLIC_ICHOOSERX_BE_BASE_URL}/api/v1/saved_drugs`, {
//         credentials: 'include',
//       });
...
//     } catch (err) {
//       console.error('Failed to refetch saved drugs:', err);
//     }
//   }
...
//         ? selectedFilters.map((f) => `filters[]=${encodeURIComponent(f)}`).join('&')
//         : '';

//       // Use your existing service/api function
...
//       try {
//         // Hard-coded userId=1 for demo; adapt to your app's logic
...
//       await fetchdrugs(); // Refresh local state
//     } catch (error) {
...
//   /**
//    * Return your full dashboard layout
//    */
//   return (
