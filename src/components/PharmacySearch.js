...
export default function PharmacySearch() {
  ...
  return (
    <div className="border-borderColor border p-4 rounded shadow bg-background text-foreground">
      ...
      {pharmacies.length > 0 && (
        <div className="max-h-[400px] overflow-y-auto border-borderColor border rounded-lg p-2 shadow-inner">
          <ul className="mt-4 space-y-2">
            {pharmacies.map((pharmacy) => (
              <li key={pharmacy.id} className="border-borderColor border p-2 rounded bg-background text-foreground transition-colors">
